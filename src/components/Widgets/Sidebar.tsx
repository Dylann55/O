...
const navigation = [
    {
        id: 1,
        label: "Organizacion",
        url: "/Organization/MyOrganizations",
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 opacity-75"
            ...
            <div className="sticky inset-x-0 bottom-0 border-t border-gray-100 bg-zinc-900 p-2">
                <form onSubmit={CloseSession}>
                    ...
                    >
                        ...
                        <span style={{ pointerEvents: "none" }} className="absolute w-24 text-center top-1/2 ms-4 -translate-y-1/2 translate-x-3/4 ml-6 rounded bg-gray-900 py-1.5 text-xs font-medium text-white opacity-0 group-hover:opacity-100">
                            Cerrar Sesion
                        </span>
